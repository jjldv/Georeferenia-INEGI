/**
 * Manipulacion de georeferenciacion
 * @package select2
 * @author J. Jose Luis Dennis Vargas (jesus.dennis@stjsonora.gob.mx)
 * @Date 2016/09/26
 * @version     SVN: $Rev: 581 $
 * Last Editor  $Author: dennis $
 * Last Edit:   $Date: 2016-10-13 12:58:48 -0700 (jue., 13 oct. 2016) $
 */
...
/**
 * Establecer el select el catalogo de paises
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 */
...
/**
 * Establecer el select el catalogo de vialidades
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 */
...
/**
 * Establecer select el catalogo de estados con referencia al pais seleccionado
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 */
...
/**
 * Establecer select el catalogo de municipios con referencia al estado seleccionado
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 */
...
/**
 * Establecer select el catalogo de localidades con referencia al municipio
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 */
...
/**
 * Establecer select el catalogo de colonias con referencia a la localidad
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 */
...
/**
 * Establecce nuevo dropdopown a select
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 * @param  {object}   _selector Selector jquery a aplicar
 * @param  {json}   _data     informacion a desplegar con formato {id|text}
 */
...
/**
 * Funcion para establecer los selects en base a llaves
 * @author J. Jose Luis Dennis <jesus.dennis@stjsonora.gob.mx>
 * @date   2016-10-26
 * @param  {int}   _idCatPais      [description]
 * @param  {int}   _idCatEstado    [description]
 * @param  {int}   _idCatMunicipio [description]
 * @param  {int}   _IdCatLocalidad [description]
 * @param  {int}   IdCatColonia    [description]
 */
